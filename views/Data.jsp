...
<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js'></script><link rel='stylesheet prefetch' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'>
</head>
...
<body>
   ...
   <div class="boxsearch" align="center">
      ...
      <div class="searchpos row" >
    			<div class="column">
             			Search here:
       			</div>
            
    			 <div class="column">
    			 <input id='search' class="inputMaterial1" type='text' oninput="compareValues(this)" placeholder="First Last">
    			 </div>
      			 <div class="column">
   				 <input id='notFound' class="inputMaterial1" type='text' style="border-bottom:0px;" readonly> 
   				 </div>
				<div class="" align="">
				<button class="" id="logout" onclick="redirect();">Logout</button>	
				</div>
		</div>
	</div>
			 ...
			 <form action="Login.obj"  method="post" > 
    			...
    			<div class="group">      
	  			...
	  			<div class="group">      
   				...
   				<div class="group">      
						      <input class="inputMaterial" type="number" name="bill" id="bill" required>
						      <span class="highlight"></span>
						      <span class="bar"></span>
						      <label>Bill</label>
...
$(".btn[data-target='#myModal']").click(function() {
  ...
  var modalForm = $('<form role="form" name="modalForm" action="Editdata.obj" method="post"></form>');
  $.each(columnHeadings, function(i, columnHeader) {
	...
	else {formGroup.append('<input name="SNo" value="'+columnValues[i]+'" type="hidden" />'); };
...
////////////////////////
    function redirect()
 {
 window.location.href = "http://localhost:8080/AirSpaceTelecomm_134161/index.obj";
 }
    ...
    function compareValues(input) {
        ...
        for (var i = 1; i < myTable.rows.length; ++i) {
            ...
            let name = myTable.rows[i].cells[1].innerText;//a
